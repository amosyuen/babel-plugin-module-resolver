...
function resolvePathFromRelativeConfig(sourcePath, currentFile, opts) {
  ...
  var absFileInRoot = (0, _utils.nodeResolvePath)(sourcePath, _path2.default.dirname(currentFile), opts.extensions);
...
var resolvers = [resolvePathFromRelativeConfig, resolvePathFromAliasConfig, resolvePathFromRootConfig];
