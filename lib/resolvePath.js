...
function resolvePathFromRelativeConfig(sourcePath, currentFile, opts) {
  ...
  const absFileInRoot = (0, _utils.nodeResolvePath)(sourcePath, _path2.default.dirname(currentFile), opts.extensions);
...
const resolvers = [resolvePathFromRelativeConfig, resolvePathFromAliasConfig, resolvePathFromRootConfig];
